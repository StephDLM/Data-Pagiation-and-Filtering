...
div.setAttribute('id','boat-container');

  // 2b. Set the `DIV` element's `class` attribute equal to "boat-container"
div.setAttribute('class','boat-container');
...
img.setAttribute('alt',"Tugboat"); 
  // 3c. Set the `IMG` element's `id` attribute equal to "boat-img"
img.setAttribute('id',"boat-img"); 
